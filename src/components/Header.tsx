      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            <Camera className="w-7 h-7 text-stone-100 group-hover:text-stone-300 transition-colors duration-300" />
          ...
          <nav className="hidden md:flex space-x-12">
            {navigation.map((item) => (
              ...
              >
                {item.name}
                <span className={`absolute -bottom-1 left-0 w-0 h-px bg-stone-100 transition-all duration-300 group-hover:w-full ${
